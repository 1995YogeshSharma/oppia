...
def block_footer_js(context, missing=missing):
    ...
    pass
    yield u'\n  %s\n  <script src="%s/pages/email_dashboard/EmailDashboard.js"></script>\n  <script src="%s/pages/email_dashboard/EmailDashboardDataService.js"></script>\n' % (
...
debug_info = '1=11&84=17&85=25&86=26&87=27&81=30&28=37&3=44&7=51&8=58&19=61'