...
def block_footer_js(context, missing=missing):
    ...
    pass
    yield u'\n  %s\n  <script src="%s/pages/signup/Signup.js"></script>\n' % (
...
def block_maintitle(context, missing=missing):
    ...
    if 0: yield None
    pass
    yield u'I18N_SIGNUP_PAGE_TITLE'
...
debug_info = '1=11&22=17&94=24&112=27&113=35&114=36&3=39&14=46&15=55&18=56&5=59'